...
class FormatterNumbers {
  ...
  format(value, locale) {
    let formatter;
    if (typeof locale === "undefined" || !type.Type.isStringFilled(locale)) {
      locale = type.Type.isStringFilled(this._defLocale) ? this._defLocale || "en" : typeof navigator === "undefined" ? "en" : navigator?.language || "en";
    }
...
exports.default = FormatterNumbers;
