...
const protobuf = require('../../_virtual/protobuf2.cjs');

var hasRequiredProtobuf;

function requireProtobuf () {
	if (hasRequiredProtobuf) return protobuf.__module.exports;
	...
	(function (module) {
		...
		(function(undefined$1) {
		  (/* @__PURE__ */ __name((function prelude(modules, cache, entries) {
		    ...
		    util.isNode = Boolean(_commonjsHelpers.commonjsGlobal.process && _commonjsHelpers.commonjsGlobal.process.versions && _commonjsHelpers.commonjsGlobal.process.versions.node);
		    ...
		    _commonjsHelpers.commonjsGlobal.dcodeIO && /* istanbul ignore next */
		    _commonjsHelpers.commonjsGlobal.dcodeIO.Long || util.inquire("long");
	...
	return protobuf.__module.exports;
}

exports.__require = requireProtobuf;
