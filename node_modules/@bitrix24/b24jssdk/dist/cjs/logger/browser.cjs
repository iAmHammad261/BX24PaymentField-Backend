...
const loggerFactory = require('./logger-factory.cjs');
...
class LoggerBrowser {
  ...
  constructor(title, isDevelopment = false) {
    ...
    if (isDevelopment) {
      this.#logger = loggerFactory.LoggerFactory.createForBrowserDevelopment(title);
    } else {
      this.#logger = loggerFactory.LoggerFactory.createForBrowserProduction(title);
    }
  }
  // region Config ////
  /**
